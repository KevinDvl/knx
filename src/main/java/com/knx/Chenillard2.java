...
public class Chenillard2 extends Thread implements Chenillard{
	...
	public Chenillard2(ProcessCommunicator pc, int tempsFin, Boolean start, Boolean firstStart){
		this.pc = pc;
	...
	public void run() {
    	...
    	System.out.println("chenillard2 started..");
